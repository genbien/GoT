            ...
            if line:
                if title_pattern.match(line):
                    ...
                    if chapter:
                        ...
                        chapter_words = nlp(chapter)
                        for word in chapter_words:
                            chapter_set.add(word.lemma_)
                        book.append((chapter_set, i))
                    chapter = []
                else:
...
ep1 = open("scene_chapter_auto_align/common_lemmas/auto_align_ep01.txt", 'w')
ep2 = open("scene_chapter_auto_align/common_lemmas/auto_align_ep02.txt", 'w')
ep3 = open("scene_chapter_auto_align/common_lemmas/auto_align_ep03.txt", 'w')
ep4 = open("scene_chapter_auto_align/common_lemmas/auto_align_ep04.txt", 'w')
ep5 = open("scene_chapter_auto_align/common_lemmas/auto_align_ep05.txt", 'w')
...
plt.scatter(x, y)
plt.savefig('GoT_chapter_scene_alignment_lemmas_in_common.eps', format='eps', dpi=1000)
# plt.show()