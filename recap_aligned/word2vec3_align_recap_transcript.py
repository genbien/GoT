...
## Distance #7 - word2vec with added transcripts context (moving window)
## based on distance #5 (word2vec with individual words)
##
################################################################################
...
def createDistanceMatrix(scene, transcript):
    ...
    for tidx, t in enumerate(transcript):
        ...
        t_vec_matrix[tidx] = np.array([t_word.vector for t_word in trans_words] + [t_word.vector for t_word in trans_words_pre] + [t_word.vector for t_word in trans_words_nxt])
...
output     = '../../../1_scripts/GoT_git/recap_aligned/word2vec3_auto_align/{episode}.txt'
tuple_file = '../../../1_scripts/GoT_git/recap_aligned/word2vec3_auto_align/tuples/auto_aligned_{episode}.txt'
dist_file  = '../../../1_scripts/GoT_git/recap_aligned/word2vec3_auto_align/dist_matrix/dist_matrix_{episode}.txt'
