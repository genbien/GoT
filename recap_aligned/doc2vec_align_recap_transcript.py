...
sources = {
    ...
    '../../../0_corpus/books/AClashOfKings.txt':'CLASHOFKINGS',
    '../../../0_corpus/books/ADanceWithDragons.txt':'DANCEWITHDRAGONS',
    '../../../0_corpus/books/AGameOfThrones.txt':'GAMEOFTHRONES',
    '../../../0_corpus/books/AStormOfSwords.txt':'STROMOFSWORDS'
}
