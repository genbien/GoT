...
## Distance #4.5 - word2vec with all word vec (for noun, adj, and verb) in a doc
##   summed for comparison with summed word vecs (for noun, adj, and verb) from
##   a second doc
##
################################################################################
...
def createDistanceMatrix(scene, transcript):
    ...
    for t in transcript:
        ...
        for word in transcript_words:
            if any(p in word.pos_ for p in pos):
                print("transcript:", word.pos_, word)
...
output     = '../../../1_scripts/GoT_git/recap_aligned/pos_auto_align/{episode}.txt'
tuple_file = '../../../1_scripts/GoT_git/recap_aligned/pos_auto_align/tuples/auto_aligned_{episode}.txt'
dist_file  = '../../../1_scripts/GoT_git/recap_aligned/pos_auto_align/dist_matrix/dist_matrix_{episode}.txt'
